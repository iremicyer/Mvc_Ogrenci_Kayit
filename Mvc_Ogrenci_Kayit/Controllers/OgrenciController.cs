...
namespace Mvc_Ogrenci_Kayit.Controllers
{
    public class OgrenciController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OgrID,OgrAd,OgrSoyad,OgrMail,OgrFotograf,OgrAdres")] Ogrenci ogrenci)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OgrID,OgrAd,OgrSoyad,OgrMail,OgrFotograf,OgrAdres")] Ogrenci ogrenci)
        {
            if (ModelState.IsValid)
            {
